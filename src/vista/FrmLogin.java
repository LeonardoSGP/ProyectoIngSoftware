...
public class FrmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(136, 22, 48));
        jPanel1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel1.setPreferredSize(new java.awt.Dimension(350, 500));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Miscelanea Smart.png"))); // NOI18N
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel6)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(mostrar2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
    ...
    private void Login() {
        if (!txt_usuario.getText().isEmpty() && !txt_password.getText().isEmpty()) {
            ...
            if (controlUsuario.loginUser(usuario)) {
                ...
                // Comparar directamente contra admin
                boolean esAdmin = usuario.getUsuario().equals("Admin")
                        && usuario.getPassword().equals("Rangers18");

                FrmMenu menu = new FrmMenu();
                menu.setAdmin(esAdmin); // método personalizado en FrmMenu
