...
public class FrmMenu extends javax.swing.JFrame {
    ...
    private void configurarMenuPorRol() {
        if (!esAdmin) {
            // Desactiva acceso a categorías
            jMenuItem_nueva_categoria.setEnabled(false);
            jMenuItem_gestionar_categorias.setEnabled(false);

            // Desactiva acceso a productos
            jMenuItem3_nuevo_producto.setEnabled(false);
            jMenuItem_gestionar_producto.setEnabled(false);
            jMenuItem_actualizar_stock.setEnabled(false);

            // Desactiva acceso a usuarios
            jMenuItem_nuevo_usuario.setEnabled(false);
            jMenuItem_gestionar_usuario.setEnabled(false);

            // Desactiva reportes
            jMenuItem_reportes_ventas.setEnabled(false);
            jMenuItem_reportes_clientes.setEnabled(false);
            jMenuItem_reportes_productos.setEnabled(false);
            jMenuItem_reportes_categorias.setEnabled(false);
